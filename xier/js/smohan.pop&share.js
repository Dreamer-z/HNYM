...
(function($) {
    $.fn.SmohanPopLayer = function(options) {
        ...
        var layerhtml = "";
        if (options.Shade == true) { layerhtml += '<div class="Smohan_Layer_Shade" style="display:none;"></div>'; }
        layerhtml += '<div class="Smohan_Layer_box" style="width:' + 600 + 'px;height:' + 120 + 'px; margin-top:-' + 60 + 'px;margin-left:-' + 300 + 'px;display:none;" id="layer_' + options.Content + '">';
        ...
        if (options.Event == "unload") {
            $('#layer_' + options.Content).animate({ opacity: 'show', marginTop: '-' + layer_top + 'px' }, "slow", function() {
...
$(document).ready(function(e) {
    ...
    var share_pic = "/images/ewm.jpg"; //默认的分享图片
