...
$(function(){
	...
	//下一张
	$("http://47.94.100.219:8358/templates/main/js/.pic-scroll .next").bind("click",function(){
	...
	//上一张
	$("http://47.94.100.219:8358/templates/main/js/.pic-scroll .prev").bind("click",function(){
		if(tempLength > 0){
